...
struct catalog_type {
   ...
   catalog_type()
       : info(family<prometheus::Info>("funode", "static information about the server"))
       , http_request_counts(family<Counter>("funode_http_requests_total", "number of HTTP requests"))
       , failed_p2p_connections(build<Counter>("funode_p2p_failed_connections", "total number of failed out-going p2p connections"))
       , dropped_trxs_total(build<Counter>("funode_p2p_dropped_trxs_total", "total number of dropped transactions by net plugin"))
       , p2p_metrics{
              .num_peers{build<Gauge>("funode_p2p_peers", "current number of connected outgoing peers")}
            , .num_clients{build<Gauge>("funode_p2p_clients", "current number of connected incoming clients")}
            , .addr{family<Gauge>("funode_p2p_addr", "ipv6 address")}
            , .port{family<Gauge>("funode_p2p_port", "port")}
            , .connection_number{family<Gauge>("funode_p2p_connection_number", "monatomic increasing connection number")}
            , .accepting_blocks{family<Gauge>("funode_p2p_accepting_blocks", "accepting blocks on connection")}
            , .last_received_block{family<Gauge>("funode_p2p_last_received_block", "last received block on connection")}
            , .first_available_block{family<Gauge>("funode_p2p_first_available_block", "first block available from connection")}
            , .last_available_block{family<Gauge>("funode_p2p_last_available_block", "last block available from connection")}
            , .unique_first_block_count{family<Gauge>("funode_p2p_unique_first_block_count", "number of blocks first received from any connection on this connection")}
            , .latency{family<Gauge>("funode_p2p_latency", "last calculated latency with connection")}
            , .bytes_received{family<Gauge>("funode_p2p_bytes_received", "total bytes received on connection")}
            , .last_bytes_received{family<Gauge>("funode_p2p_last_bytes_received", "last time anything received from peer")}
            , .bytes_sent{family<Gauge>("funode_p2p_bytes_sent", "total bytes sent to peer")}
            , .last_bytes_sent{family<Gauge>("funode_p2p_last_bytes_sent", "last time anything sent to peer")}
            , .block_sync_bytes_received{family<Gauge>("funode_p2p_block_sync_bytes_received", "bytes of blocks received during syncing")}
            , .block_sync_bytes_sent{family<Gauge>("funode_p2p_block_sync_bytes_sent", "bytes of blocks sent during syncing")}
            , .block_sync_throttling{family<Gauge>("funode_p2p_block_sync_throttling", "is block sync throttling currently active")}
            , .connection_start_time{family<Gauge>("funode_p2p_connection_start_time", "time of last connection to peer")}
            , .peer_addr{family<Gauge>("funode_p2p_peer_addr", "peer address")}
         }
       , cpu_usage_us(family<Counter>("funode_cpu_usage_us_total", "total cpu usage in microseconds for blocks"))
       , net_usage_us(family<Counter>("funode_net_usage_us_total", "total net usage in microseconds for blocks"))
       , last_irreversible(build<Gauge>("funode_last_irreversible", "last irreversible block number"))
       , head_block_num(build<Gauge>("funode_head_block_num", "head block number"))
       , unapplied_transactions_total(build<Counter>("funode_unapplied_transactions_total",
                                                     "total number of unapplied transactions from produced blocks"))
       , subjective_bill_account_size_total(build<Counter>(
             "funode_subjective_bill_account_size_total", "total number of subjective bill account size from produced blocks"))
       , scheduled_trxs_total(
             build<Counter>("funode_scheduled_trxs_total", "total number of scheduled transactions from produced blocks"))
       , trxs_produced_total(build<Counter>("funode_trxs_produced_total", "number of transactions produced"))
       , cpu_usage_us_produced_block(cpu_usage_us.Add({{"block_type", "produced"}}))
       , total_elapsed_time_us_produced_block(build<Counter>("funode_produced_elapsed_us_total", "total produced blocks elapsed time"))
       , total_time_us_produced_block(build<Counter>("funode_produced_us_total", "total produced blocks total time"))
       , net_usage_us_produced_block(net_usage_us.Add({{"block_type", "produced"}}))
       , produced_metrics{ .num_blocks_created{build<Counter>("funode_blocks_produced", "number of blocks produced")}
                         , .current_block_num{build<Gauge>("funode_block_num", "current block number")}
                         , .block_total_time_us_block{build<Counter>("funode_total_time_us_produced_block", "total time for produced block")}
                         , .block_idle_time_us_block{build<Counter>("funode_idle_time_us_produced_block", "idle time for produced block")}
                         , .block_num_success_trx_block{build<Counter>("funode_num_success_trx_produced_block", "number of successful transactions in produced block")}
                         , .block_success_trx_time_us_block{build<Counter>("funode_success_trx_time_us_produced_block", "time for successful transactions in produced block")}
                         , .block_num_failed_trx_block{build<Counter>("funode_num_failed_trx_produced_block", "number of failed transactions during produced block")}
                         , .block_fail_trx_time_us_block{build<Counter>("funode_fail_trx_time_us_produced_block", "time for failed transactions during produced block")}
                         , .block_num_transient_trx_block{build<Counter>("funode_num_transient_trx_produced_block", "number of transient transactions during produced block")}
                         , .block_transient_trx_time_us_block{build<Counter>("funode_transient_trx_time_us_produced_block", "time for transient transactions during produced block")}
                         , .block_other_time_us_block{build<Counter>("funode_other_time_us_produced_block", "all other unaccounted time during produced block")} }
       , speculative_metrics{ .num_blocks_created{build<Counter>("funode_blocks_speculative_num", "number of speculative blocks created")}
                            , .current_block_num{build<Gauge>("funode_block_num", "current block number")}
                            , .block_total_time_us_block{build<Counter>("funode_total_time_us_speculative_block", "total time for speculative block")}
                            , .block_idle_time_us_block{build<Counter>("funode_idle_time_us_speculative_block", "idle time for speculative block")}
                            , .block_num_success_trx_block{build<Counter>("funode_num_success_trx_speculative_block", "number of successful transactions in speculative block")}
                            , .block_success_trx_time_us_block{build<Counter>("funode_success_trx_time_us_speculative_block", "time for successful transactions in speculative block")}
                            , .block_num_failed_trx_block{build<Counter>("funode_num_failed_trx_speculative_block", "number of failed transactions during speculative block")}
                            , .block_fail_trx_time_us_block{build<Counter>("funode_fail_trx_time_us_speculative_block", "time for failed transactions during speculative block")}
                            , .block_num_transient_trx_block{build<Counter>("funode_num_transient_trx_speculative_block", "number of transient transactions during speculative block")}
                            , .block_transient_trx_time_us_block{build<Counter>("funode_transient_trx_time_us_speculative_block", "time for transient transactions during speculative block")}
                            , .block_other_time_us_block{build<Counter>("funode_other_time_us_speculative_block", "all other unaccounted time during speculative block")} }
       , trxs_incoming_total(build<Counter>("funode_trxs_incoming_total", "number of incoming transactions"))
       , cpu_usage_us_incoming_block(cpu_usage_us.Add({{"block_type", "incoming"}}))
       , total_elapsed_time_us_incoming_block(build<Counter>("funode_incoming_elapsed_us_total", "total incoming blocks elapsed time"))
       , total_time_us_incoming_block(build<Counter>("funode_incoming_us_total", "total incoming blocks total time"))
       , net_usage_us_incoming_block(net_usage_us.Add({{"block_type", "incoming"}}))
       , latency_us_incoming_block(build<Counter>("funode_incoming_us_block_latency", "total incoming block latency"))
       , blocks_incoming(build<Counter>("funode_blocks_incoming", "number of incoming blocks"))
